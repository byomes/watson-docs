...
**How to trigger a skill.** Talk to Watson via the Telegram bot (`@wckyWatsonbot`). Two ways to invoke:
...
- ~~Dashboard chat (`/api/chat/stream`, `/api/chat` non-streaming duplicate, `/api/chat/sessions*` CRUD in `jobs/dashboard/app.py`)~~ — retired 2026-09-19 at Bill's request ("not useful next to telegram"). Confirmed dead before removing: zero references in any dashboard template/JS (no UI ever called it), `/api/siri` and `/api/terminal` are separate, unaffected features. The `chat_sessions`/`chat_messages` DB tables themselves are untouched — `bot/bot.py` owns and writes them independently for Telegram's own session/memory tracking (`jobs/memory/wrap_up.py`, `reflect.py`, session archives), so that history and those jobs are unaffected. ~1300 lines removed, commit `6d347a2`.
...
### ~/watson
- 29dedb2 docs: bugs/backlog export 2026-09-14
- 7dc7365 docs: file map 2026-09-14
- 3f5fa4b kb: sync 1 transcript(s) to kb/documents (same-day)
- d0f0493 kb: sync 1 transcript(s) to kb/documents (same-day)
- 4d3e72a kb: sync 1 transcript(s) to kb/documents (same-day)
- fbd7a9e kb: sync 1 transcript(s) to kb/documents (same-day)
- b5082b6 kb: sync 1 transcript(s) to kb/documents (same-day)
- 2983c89 kb: sync 1 transcript(s) to kb/documents (same-day)
- 5e6137c kb: sync 1 transcript(s) to kb/documents (same-day)
- 1d3e512 kb: sync 1 transcript(s) to kb/documents (same-day)
- 9cba251 kb: sync 1 transcript(s) to kb/documents (same-day)
- cf1f24f kb: sync 1 transcript(s) to kb/documents (same-day)
- be5dab4 kb: sync 1 transcript(s) to kb/documents (same-day)
- 80ebfdd kb: sync 1 transcript(s) to kb/documents (same-day)
- 98d1f39 kb: sync 1 transcript(s) to kb/documents (same-day)
- ff1d74d kb: sync 1 transcript(s) to kb/documents (same-day)
- 71daba3 kb: sync 1 transcript(s) to kb/documents (same-day)
- e052de3 kb: sync 1 transcript(s) to kb/documents (same-day)
- 771f0c8 kb: sync 1 transcript(s) to kb/documents (same-day)
- f307d18 kb: sync 1 transcript(s) to kb/documents (same-day)
- 6ec9424 kb: sync 1 transcript(s) to kb/documents (same-day)
- 38cdc56 kb: sync 1 transcript(s) to kb/documents (same-day)
- 04b90f3 kb: sync 1 transcript(s) to kb/documents (same-day)
- d361592 kb: sync 1 transcript(s) to kb/documents (same-day)
- b7a2c6f kb: sync 1 transcript(s) to kb/documents (same-day)
- 5a4a248 kb: sync 1 transcript(s) to kb/documents (same-day)
- 8106514 kb: sync 1 transcript(s) to kb/documents (same-day)
- a501a97 kb: sync 1 transcript(s) to kb/documents (same-day)
- a4a34f8 kb: sync 1 transcript(s) to kb/documents (same-day)
- b2575df kb: sync 1 transcript(s) to kb/documents (same-day)
- b8312fd fix: parse MM-DD-YY (2-digit year) and non-padded dates in sermon filenames
- 8559f0f kb: restore true 2012 preached dates for 36 mis-dated sermon transcripts
- 4b2c322 kb: sync 1 transcript(s) to kb/documents (same-day)
- 79fe9ca kb: sync 1 transcript(s) to kb/documents (same-day)
- 697331c kb: sync 1 transcript(s) to kb/documents (same-day)
- 7637f27 kb: sync 1 transcript(s) to kb/documents (same-day)
- 7b50acb kb: sync 1 transcript(s) to kb/documents (same-day)
- 92110df kb: sync 1 transcript(s) to kb/documents (same-day)
- baebb1f kb: sync 1 transcript(s) to kb/documents (same-day)
- 2666911 kb: sync 1 transcript(s) to kb/documents (same-day)
- b1b2512 kb: sync 1 transcript(s) to kb/documents (same-day)
- ec21c12 kb: sync 1 transcript(s) to kb/documents (same-day)
- ec08e69 kb: sync 1 transcript(s) to kb/documents (same-day)
- 58ccace kb: sync 1 transcript(s) to kb/documents (same-day)
- 8c2b4b2 kb: sync 1 transcript(s) to kb/documents (same-day)
- dba1cc4 kb: sync 1 transcript(s) to kb/documents (same-day)
- eb4775b kb: sync 1 transcript(s) to kb/documents (same-day)
- e144bb6 kb: sync 1 transcript(s) to kb/documents (same-day)
- 2909dd1 kb: sync 1 transcript(s) to kb/documents (same-day)
- bb77ba5 kb: sync 1 transcript(s) to kb/documents (same-day)
- 72650d3 kb: sync 1 transcript(s) to kb/documents (same-day)
- a4b5f14 kb: sync 1 transcript(s) to kb/documents (same-day)
- bf368f9 kb: sync 1 transcript(s) to kb/documents (same-day)
- c9f6cfe kb: cross-reference undated sermons against Bill's preaching-plan calendar
- cebadb7 kb: sync 1 transcript(s) to kb/documents (same-day)
- 9849637 kb: sync 1 transcript(s) to kb/documents (same-day)
- 3b432ef fix: fall back to most recent Sunday, not today, for undated sermons
- 61681fe kb: sync 1 transcript(s) to kb/documents (same-day)
- 1180a16 kb: sync 1 transcript(s) to kb/documents (same-day)
- 7ca7cde kb: sync 1 transcript(s) to kb/documents (same-day)
- c96388b kb: weight sermon search toward post-2022 material Bill trusts more
- d556b7d kb: sync 1 transcript(s) to kb/documents (same-day)
- 21e868e kb: restore true preached dates for 10 mis-dated 2011 sermon transcripts
- 9e8295e fix: preserve original preached date when ingesting historical sermons
- 722a7f3 kb: sync 1 transcript(s) to kb/documents (same-day)
- 1a4c9cf fix: wire archive-mode sermon transcripts to reach the Beelink KB
- d73567d kb: sync 1 transcript(s) to kb/documents (same-day)
- 20d3324 kb: sync 1 transcript(s) to kb/documents (same-day)
- 628efef kb: sync 1 transcript(s) to kb/documents (same-day)
- 413d121 kb: sync 1 transcript(s) to kb/documents (same-day)
- d9e9c9c Prevent duplicate attendance rows when merging duplicate members
- f689f04 kb: sync 1 transcript(s) to kb/documents (same-day)
- 672c3d6 kb: sync 1 transcript(s) to kb/documents (same-day)
- 251f9a2 kb: sync 1 transcript(s) to kb/documents (same-day)
- a262958 kb: sync 1 transcript(s) to kb/documents (same-day)
- a9d4515 kb: sync 1 transcript(s) to kb/documents (same-day)
- 9346d82 kb: sync 1 transcript(s) to kb/documents (same-day)
- d6ef295 kb: sync 1 transcript(s) to kb/documents (same-day)
- 425d3e5 kb: sync 1 transcript(s) to kb/documents (same-day)
- d9f3db4 kb: sync 1 transcript(s) to kb/documents (same-day)
- b09606f kb: sync 1 transcript(s) to kb/documents (same-day)
- acce169 kb: sync 1 transcript(s) to kb/documents (same-day)
- e180924 kb: sync 1 transcript(s) to kb/documents (same-day)
- 873fac2 kb: sync 1 transcript(s) to kb/documents (same-day)
- 23162a4 kb: sync 1 transcript(s) to kb/documents (same-day)
- 7ee399f kb: sync 1 transcript(s) to kb/documents (same-day)
- 2f299bd kb: sync 1 transcript(s) to kb/documents (same-day)
- 069121c kb: sync 1 transcript(s) to kb/documents (same-day)
- 9250481 kb: sync 1 transcript(s) to kb/documents (same-day)
- 6e2c329 kb: sync 1 transcript(s) to kb/documents (same-day)
- 779abe2 kb: sync 1 transcript(s) to kb/documents (same-day)
- bc624fe kb: sync 1 transcript(s) to kb/documents (same-day)
- d718054 kb: sync 1 transcript(s) to kb/documents (same-day)
- 0111ed1 kb: sync 1 transcript(s) to kb/documents (same-day)
- 30db53f kb: sync 1 transcript(s) to kb/documents (same-day)
- 09f860f kb: sync 1 transcript(s) to kb/documents (same-day)
- 418688d kb: sync 1 transcript(s) to kb/documents (same-day)
- 6203ea7 kb: sync 1 transcript(s) to kb/documents (same-day)
- d8cab44 kb: sync 1 transcript(s) to kb/documents (same-day)
- c23c2d0 kb: sync 1 transcript(s) to kb/documents (same-day)
- a0a2e0f kb: sync 1 transcript(s) to kb/documents (same-day)
- 5293202 kb: sync 1 transcript(s) to kb/documents (same-day)
- d198554 kb: sync 1 transcript(s) to kb/documents (same-day)
- 2097b17 kb: sync 1 transcript(s) to kb/documents (same-day)
- 9ebadca kb: sync 1 transcript(s) to kb/documents (same-day)
- 76f6a9a kb: sync 1 transcript(s) to kb/documents (same-day)
- d21690c kb: sync 1 transcript(s) to kb/documents (same-day)
- 746de8a kb: sync 1 transcript(s) to kb/documents (same-day)
- bcdf014 kb: sync 1 transcript(s) to kb/documents (same-day)
- 497b42c kb: sync 1 transcript(s) to kb/documents (same-day)
- 838c82d kb: sync 1 transcript(s) to kb/documents (same-day)
- f52aa31 kb: default search to all content, not just sermon transcripts
- f64b22a kb: sync 1 transcript(s) to kb/documents (same-day)
- faf6209 kb: sync 1 transcript(s) to kb/documents (same-day)
- 9753a01 kb: sync 1 transcript(s) to kb/documents (same-day)
- 72922ad kb: sync 1 transcript(s) to kb/documents (same-day)
- eae120f kb: sync 1 transcript(s) to kb/documents (same-day)
- 6aee21f kb: sync 1 transcript(s) to kb/documents (same-day)
- 67d538e kb: sync 1 transcript(s) to kb/documents (same-day)
- fbe50fc kb: sync 1 transcript(s) to kb/documents (same-day)
- bc21035 kb: sync 1 transcript(s) to kb/documents (same-day)
